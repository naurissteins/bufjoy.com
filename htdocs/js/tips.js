...
function init_tooltip() {
	...
	v_yoffset = 15;
	v_backcolor = '#EEEEEE';
	v_bordercolor = '#333333';
	v_textcolor = '#000000';
	v_titletextcolor = '#FFFFFF';
	v_width = 640;
...
function makeHTML(text, title) {
	...
	var content_style = 'text-align:left;padding:' + v_content_padding + ';';
...
function createBackLayer(width, Z) {
	return '<iframe src="javascript:false" id="backdrop" frameborder="0" scrolling="no" width="' + width + '" height="0" style="z-index: ' + Z + '; filter: Beta(Style=0,Opacity=0);"><p></iframe>';
}
