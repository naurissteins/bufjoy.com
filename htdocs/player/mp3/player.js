...
$jscomp.findInternal = function (c, f, v) {
    ...
    for (var p = c.length, a = 0; a < p; a++) {
        var e = c[a];
        if (f.call(v, e, a, c)) return { i: a, v: e };
    }
    return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill = function (c, f, v, p) {
    if (f) {
        ...
        p = v[c];
        f = f(p);
        f != p && null != f && $jscomp.defineProperty(v, c, { configurable: !0, writable: !0, value: f });
    }
};
$jscomp.polyfill(
    ...
    function (c) {
        return c
            ...
            : function (c, v, p) {
                  ...
                  for (v = Number(v || 0); v < p; v++) this[v] = c;
                  return this;
              };
    },
    "es6",
    ...
    "function" == typeof Object.assign
        ...
        : function (c, f) {
              for (var v = 1; v < arguments.length; v++) {
                  var p = arguments[v];
                  if (p) for (var a in p) $jscomp.owns(p, a) && (c[a] = p[a]);
              }
              return c;
          };
$jscomp.polyfill(
...
function dzsap_generate_keyboard_controls() {
    var c = { play_trigger_step_back: "off", step_back_amount: "5", step_back: "37", step_forward: "39", sync_players_goto_next: "", sync_players_goto_prev: "", pause_play: "32", show_tooltips: "off" };
...
function register_dzsap_plugin() {
    (function (c) {
        function f(a, c) {
            ...
            var e = "";
            a && ((a = { r: parseInt(a[1], 16), g: parseInt(a[2], 16), b: parseInt(a[3], 16) }), (e = 1), c && (e = c), (e = "rgba(" + a.r + "," + a.g + "," + a.b + "," + e + ")"));
            return e;
        }
        ...
        c.fn.audioplayer = function (a) {
            ...
            this.each(function () {
                function W() {
                    Xa = Z = ma = aa = 0;
                    a.sample_time_start ||
                        (b.attr("data-sample_time_start") && (aa = Number(b.attr("data-sample_time_start"))),
                    ...
                    0 == isNaN(Number(a.sample_time_start)) &&
                ...
                function u() {
                    ...
                    0 != b.hasClass("first-played") ||
                        ...
                        ((B = pb = 0), c(m) && c(m).html() && -1 < c(m).html().indexOf("api.soundcloud.com") && 0 != m.currentTime && oa(0, { call_from: "first_played_false" }));
                    if ("fake" == y || a.fakeplayer) 0 == b.hasClass("current-feeder-for-parent-player") && ha && (H = ha), 0 == B && m && ((B = m.duration), (H = m.currentTime)), (gd = H), (Dc = B);
                }
                function n() {
                ...
                function l(a) {
                    ...
                    if ("click" == a.type && (b.hasClass("comments-btn-cancel") && (d.removeClass("active"), d.find("input").val("")), b.hasClass("comments-btn-submit")))
                ...
                function Bb() {
                    ...
                    "skin-wave" == a.design_skin &&
                        ("small" == L && (c = 60),
                        C && (0 == d ? C.css("top", w.offset().top - b.offset().top + c * d - C.height()) : (C.css("top", w.offset().top - w.parent().offset().top + c * d), X.css("top", w.offset().top - w.parent().offset().top + c * d))),
                ...
                function Cb(a, b) {
                    ...
                    var d = {};
                    b && (d = c.extend(d, b));
                    q && q.get(0) && q.get(0).api_pause_media_visual && q.get(0).api_pause_media_visual({ call_from: "change_visual_target" });
                    q = a;
                    console.log("new _feed_fakePlayer -  ", q);
                    var g = q.get(0);
                    ta && q && g && g.api_play_media_visual && g.api_play_media_visual();
                    g && g.api_draw_curr_time && (g.api_set_time_curr(H), g.api_get_times({ call_from: " change visual target .. in api " }), g.api_check_time({ fire_only_once: !0 }), g.api_draw_curr_time(), g.api_draw_scrub_prog());
                    setTimeout(function () {
                        g && g.api_draw_curr_time && (g.api_get_times(), g.api_check_time({ fire_only_once: !0 }), g.api_draw_curr_time(), g.api_draw_scrub_prog());
                    }, 800);
                }
                function Db(d) {
                    a.design_wave_color_progress = d;
                    "canvas" == a.skinwave_wave_mode &&
                        (Ha(Za.get(0), b.attr("data-pcm"), "#" + a.design_wave_color_bg, { call_from: "canvas_change_pcm_bg" }),
                ...
                function hc(d, g) {
                    ...
                    e && q && q.get(0).api_pause_media_visual({ call_from: "change_media" });
                    "on" == h.fakeplayer_is_feeder
                        ? ((q = d),
                    ...
                    if (d) {
                        ...
                        if (0 < d.find(".meta-artist").length || 0 < d.find(".meta-artist-con").length) (h.artist = d.find(".the-artist").eq(0).html()), (h.song_name = d.find(".the-name").eq(0).html());
                        d.attr("data-thumb_for_parent") && (h.thumb = d.attr("data-thumb_for_parent"));
                        if (0 < d.find(".feed-song-name").length || 0 < d.find(".feed-artist-name").length) (h.artist = d.find(".feed-artist-name").eq(0).html()), (h.song_name = d.find(".feed-song-name").eq(0).html());
                    }
                    if (q) {
                    ...
                    ya &&
                        ...
                        0 < e.find(".meta-artist").length && ((h.artist = d.find(".the-artist").eq(0).html()), (h.song_name = d.find(".the-name").eq(0).html())),
                    ...
                    "skin-wave" == a.design_skin &&
                        ("canvas" == a.skinwave_wave_mode &&
                            ((bb = q ? d.attr("data-source") : d),
                            d && h.pcm ? (b.attr("data-pcm", d.attr("data-pcm")), ka(d.attr("data-pcm"))) : ua({ call_from: "regenerate_canvas_from_change_media" }),
                            "" != h.pcm
                                ? (ka(h.pcm), b.attr("data-pcm", h.pcm))
                                : (w.addClass("fast-animate-scrubbar"),
                                  ...
                                  setTimeout(function () {
                                      ...
                                      b.attr("data-pcm", "");
                                      Eb();
                                      ua({ call_from: "regenerate_canvas_from_change_media" });
                                  }, 120))),
                        h.thumb && (b.find(".the-thumb").length ? b.find(".the-thumb").css("background-image", "url(" + h.thumb + ")") : (b.attr("data-thumb", h.thumb), z())));
                    h.thumb
                        ? (b.find(".the-thumb").length ? b.find(".the-thumb").css("background-image", "url(" + h.thumb + ")") : (b.attr("data-thumb", h.thumb), z()), b.removeClass("does-not-have-thumb"), b.addClass("has-thumb"))
                        : (b.addClass("does-not-have-thumb"), b.removeClass("has-thumb"));
                    "" == h.pcm && Q();
                    q && (q.attr("data-playerid") ? (za = q.attr("data-playerid")) : q.attr("data-source") && (za = q.attr("data-source")));
                    ea &&
                        ((e = ea.children(".dzstooltip--inner")),
                        e.children().removeClass("current-playlist-item"),
                        e.children().each(function () {
                            var a = c(this);
                            a.attr("data-playerid") == h.playerid && (a.addClass("current-playlist-item"), (ic = 0));
                        }));
                    e = 100;
                    q && d.find(".meta-artist").eq(0).html();
                    if (q) {
                        var f = null;
                        q.find(".feed-dzsap-for-extra-html-right").length
                            ? (f = q.find(".feed-dzsap-for-extra-html-right").eq(0))
                            : q.attr("data-playerid") &&
                              c(document).find('.feed-dzsap-for-extra-html-right[data-playerid="' + q.attr("data-playerid") + '"]').length &&
                              (f = c(document)
                                  .find('.feed-dzsap-for-extra-html-right[data-playerid="' + q.attr("data-playerid") + '"]')
                                  .eq(0));
                    ...
                    "soundcloud" == g && -1 == h.source.indexOf("api.soundcloud")
                        ? ((xa = h.source),
                          ...
                          Fb())
                        : Da({ call_from: "change_media" });
                    W();
                    Gb && db(Gb, { call_from: "change_media" });
                    if ("fake" == y) return !1;
                ...
                function hb(a, g) {
                    ...
                    Da(a);
                    (is_android() || is_ios()) && Y({ call_from: "click_for_setup_media" });
                }
                function Fc(b) {
                ...
                function Gc(d) {
                    ...
                    if (!a.skinwave_comments_links_to) {
                        if ("off" == a.skinwave_comments_allow_post_if_not_logged_in && "none" == a.skinwave_comments_account) return !1;
                        var e = !0;
                        C.children().each(function () {
                            var a = c(this);
                            if (!a.hasClass("placeholder") && !a.hasClass("the-bg") && ((a = a.offset().left - g.offset().left), 20 > Math.abs(a - h))) return C.find(".dzstooltip-con.placeholder").remove(), (e = !1);
                        });
                        if (!e) return !1;
                        ...
                        var f = h + d - X.width() / 2 + 7,
                            k = -1;
                        f < d
                            ? ((k = f + 32), (f = d), b.append('<style class="comments-writter-temp-css">.audioplayer.skin-wave .comments-writer .comments-writer-inner:before{ left:' + k + "px  }</style>"))
                            : f > pa - d - X.width() / 2
                            ? ((k = h - (X.offset().left - b.offset().left) + X.width() / 3),
                              (f = pa - d - X.width() / 2),
                              b.append('<style class="comments-writter-temp-css">.audioplayer.skin-wave .comments-writer .comments-writer-inner:before{ left:' + k + "px  }</style>"))
                            : b.find(".comments-writter-temp-css").remove();
                        X.css("left", f + "px");
                        X.css({ left: "50%", top: "80px", transform: "translate3d(-50%,0,0)", width: "100%" });
                        X.css("top", parseInt(C.css("top"), 10) + 20 + "px");
                        0 == X.hasClass("active") &&
                            (X.css({ height: X.find(".comments-writer-inner").eq(0).outerHeight() + 20 }),
                            X.addClass("active"),
                    ...
                    if (1 != ab)
                        return (
                            ...
                            (m = new YT.Player(a + "", {
                                ...
                                playerVars: { origin: "", controls: 1, showinfo: 0, playsinline: 1, rel: 0, autohide: 0, wmode: "transparent", iv_load_policy: "3" },
                                events: { onReady: Nb, onStateChange: Hc },
                            })),
                            (Ic = !0),
                            !1
                        );
                ...
                function Nb(a) {
                    ...
                    m && m.getPlayerState
                        ? (Ea({ call_from: "check_yt_ready_phase_two" }),
                          Jc &&
                              setTimeout(function () {
                                  Y({ call_from: "check_yt_ready_phase_two" });
                              }, 500))
                        : setTimeout(function () {
                              Nb(a);
                          }, 1e3);
                ...
                function Hc(a) {
                    2 == a.data && Qa({ call_from: "youtube paused" });
                    1 == a.data && (Y({ call_from: "youtube playing" }), b.addClass("dzsap-loaded"));
                    -1 == a.data && ta && oa(0);
                }
                function sb() {
                    setTimeout(function () {
                ...
                function Eb(d) {
                    ...
                    if ("fake" == bb) return !1;
                    b.attr("data-pcm") ||
                        ((d = { action: "dzsap_get_pcm", postdata: "1", source: b.attr("data-source"), playerid: za }),
                                ...
                                success: function (d) {
                                    if (d)
                                        "0" != d && -1 < d.indexOf(",")
                                            ...
                                            : ((Ob = !0), ua({ call_from: "no response from pcm ajax, generate it" }));
                                    else if ("on" == a.cue) (Ob = !0), ua({ call_from: "pcm_data_try_to_generate .. no data-pcm" });
                                    else if (((hd = !0), "on" == a.pcm_data_try_to_generate_wait_for_real_pcm)) {
                                        d = [];
                                        for (var c = 0; 200 > c; c++) d[c] = Number(Math.random()).toFixed(3);
                                        d = JSON.stringify(d);
                                        ka(d);
                                        cb = !1;
                                    }
                ...
                function ua(d) {
                    var g = { call_from: "default", call_attempt: 0 };
                    d && (g = c.extend(g, d));
                    if (cb || "fake" == bb) return !1;
                    if (!Ob)
                        return (
                            setTimeout(function () {
                                g.call_attempt++;
                    ...
                    if (window.WaveSurfer) t({ call_from: "wavesurfer already loaded" });
                    else {
                        var h = document.getElementsByTagName("script");
                        d = "";
                        for (var e in h) if (h[e] && h[e].src && -1 < h[e].src.indexOf("audioplayer.js")) break;
                        e = String(h[e].src).split("/");
                        for (h = 0; h < e.length - 1; h++) d += e[h] + "/";
                        ...
                        6 > dzsap_wavesurfer_load_attempt &&
                            c.ajax({
                                url: f,
                                dataType: "script",
                                success: function (a) {
                                    t({ call_from: "load_script", wavesurfer_url: f });
                                },
                                error: function (a) {},
                            });
                    }
                ...
                function Pb(d) {
                    ...
                    d = { action: "dzsap_submit_pcm", postdata: d, playerid: za, source: b.attr("data-source") };
                    window.dzsap_generating_pcm = !1;
                    a.settings_php_handler && c.ajax({ type: "POST", url: a.settings_php_handler, data: d, success: function (a) {} });
                }
                function t(d) {
                    ...
                    var h = WaveSurfer.create({ container: "#" + d, normalize: !0, pixelRatio: 1 });
                    if (0 != String(b.attr("data-source")).indexOf("https://soundcloud.com") && "fake" != b.attr("data-source")) {
                        ...
                        h.on("error", function () {
                            ...
                            for (var a = [], b = 0; 200 > b; b++) a[b] = Math.abs(Number(Math.random()).toFixed(3));
                            a = JSON.stringify(a);
                            Pb(a);
                            ka(a);
                        });
                ...
                function ka(d) {
                    ...
                    w.find(".scrub-bg-img,.scrub-prog-img").animate({ opacity: 0 }, { queue: !1, duration: 300 });
                    R({ prepare_for_transition_in: !0 });
                    Za = b.find(".scrub-bg-img.transitioning-in");
                    $a = b.find(".scrub-prog-img.transitioning-in");
                    Ha(Za.get(0), d, "#" + a.design_wave_color_bg, { call_from: "canvas_generate_wave_data_animate_pcm_bg" });
                    Ha($a.get(0), d, "#" + a.design_wave_color_progress, { call_from: "canvas_generate_wave_data_animate_pcm_prog" });
                ...
                function z() {
                    if (b.attr("data-thumb")) {
                        ...
                        "skin-customcontrols" != a.design_skin &&
                            ("skin-wave" != a.design_skin || ("small" != L && "alternate" != L) ? ("skin-steel" == a.design_skin ? Aa.prepend(d) : O.prepend(d)) : "alternate" == L ? O.prepend(d) : Aa.prepend(d));
                        id = O.children(".the-thumb-con").eq(0);
                    } else b.removeClass("has-thumb");
                }
                function tb() {
                    b.removeClass("skin-wave-mode-normal");
                    "skin-wave" == a.design_skin &&
                        (b.addClass("skin-wave-mode-" + L),
                        ...
                        success: function (d) {
                            ...
                            try {
                                if (
                                    ((c = JSON.parse(d)),
                                    (y = "audio"),
                                    "" == c && (b.addClass("errored-out"), b.append('<div class="feedback-text">soundcloud track does not seem to serve via api</div>')),
                                    (Kc = b.attr("data-source")),
                                    c.stream_url
                                        ? (b.attr("data-source", c.stream_url + "?consumer_key=" + a.soundcloud_apikey + "&origin=localhost"),
                                          ya && ya.attr("data-source", b.attr("data-source")),
                                          q && q.attr("data-source", b.attr("data-source")))
                                        : (b.addClass("errored-out"), b.append('<div class="feedback-text ">this soundcloud track does not allow streaming  </div>')),
                                    (bb = b.attr("data-source")),
                                    b.attr("data-pcm") && (cb = !0),
                                    "skin-wave" == a.design_skin &&
                                        "canvas" == a.skinwave_wave_mode &&
                                        0 == cb &&
                                        0 == ("on" == a.pcm_data_try_to_generate && "on" == a.pcm_data_try_to_generate_wait_for_real_pcm) &&
                                        ua({ call_from: "init(), pcm not real.." }),
                                    "on" == a.cue || q || ya)
                                )
                                    Da({ call_from: "retrieve_soundcloud_url" }),
                                        setTimeout(function () {
                                            rb && (Y({ call_from: "retrieve_soundcloud_url" }), (rb = !1));
                                        }, 300);
                            } catch (Td) {
                ...
                function ba(a, b) {
                    var d = { call_from: "default" };
                    b && c.extend(d, b);
                    ea &&
                        ((b = ea.find(".dzstooltip--inner")),
                        (b = b.children().eq(a)),
                        (d = b.attr("data-playerid")),
                        (b = c('.audioplayer[data-playerid="' + d + '"],.audioplayer-tobe[data-playerid="' + d + '"]')),
                        d && b.length && b.eq(0).get(0) && b.eq(0).get(0).api_play_media
                            ? c('.audioplayer[data-playerid="' + d + '"]')
                                  .eq(0)
                                  .get(0)
                                  .api_play_media({ call_from: "api_sync_players_prev" })
                            : b.parent().parent().parent().hasClass("audiogallery")
                            ? b.parent().parent().parent().get(0).api_goto_item(a)
                            : hc(b),
                        (ic = a));
                }
                function Ia(a) {
                    ...
                    if (ea) {
                        ...
                        for (e in dzsap_list_for_sync_players)
                            (a = dzsap_list_for_sync_players[e]),
                                a.hasClass("number-wrapper") ||
                                    a.hasClass("for-number-wrapper") ||
                                    ((h += '<div class="playlist-menu-item"'),
                        ...
                        c(document).on("mousemove.dzsap_playlist_item", function (a) {
                            if (window.dzsap_moving_playlist_item) {
                                ...
                                dzsap_playlist_item_target
                                    .parent()
                                    .children(':not(".target-playlist-item"):not(".cloner")')
                                    .each(function () {
                                        var a = c(this),
                        ...
                        c(document).on("mouseup.dzsap_playlist_item", function (a) {
                            window.dzsap_moving_playlist_item &&
                                ((window.dzsap_moving_playlist_item = !1),
                ...
                function S(d) {
                    var g = { setup_inner_player: !0, setup_media: !0, setup_otherstructure: !0, call_from: "default" };
                    d && (g = c.extend(g, d));
                    ...
                    b.find(".feed-dzsap-before-playpause").length && ((f += b.find(".feed-dzsap-before-playpause").eq(0).html()), b.find(".feed-dzsap-before-playpause").remove());
                    ...
                    var k = !1;
                    if (b.hasClass("skin-wave") || b.hasClass("skin-pro") || b.hasClass("skin-silver") || b.hasClass("skin-redlights") || b.hasClass("skin-default")) k = !0;
                    k &&
                        (f +=
                    ...
                    k = '<div class="controls-volume"><div class="fa fa-volume-off"></div><div class="volume_static"></div><div class="volume_active"></div><div class="volume_cut"></div></div>';
                    ...
                    if ("skin-wave" == a.design_skin && "small" == L)
                        ...
                        "skin-silver" == a.design_skin &&
                            ...
                            (h += "</div>"),
                            va &&
                                ((h += '<div class="controls-right">' + va + "</div>"),
                            ...
                            "skin-silver" == a.design_skin
                                ? (h =
                                      h +
                                      '<div class="controls-volume controls-volume-vertical"><div class="volumeicon"></div><div class="volume-holder"><div class="volume_static"></div><div class="volume_active"></div><div class="volume_cut"></div></div></div></div>' +
                                      d)
                    ...
                    f = "";
                    va &&
                        (-1 < String(va).indexOf("dzsap-multisharer-but") && (Qb = !0), "skin-wave" != a.design_skin || "small" != L) &&
                        (f += '<div class="extrahtml-in-float-right from-setup_structure from-js-setup_structure">' + va + "</div>");
                    ca.append(h);
                    ...
                    (A && "reconstruct" != g.call_from) ||
                        (0 < b.children(".meta-artist").length &&
                            (b.hasClass("skin-wave-mode-alternate") ? (Ka.children().last().hasClass("clear") && Ka.children().last().remove(), Ka.append(b.children(".meta-artist"))) : O.append(b.children(".meta-artist"))),
                        O.find(".meta-artist").eq(0).wrap('<div class="meta-artist-con"></div>'),
                        (A = O.find(".meta-artist-con").eq(0)),
                        "skin-wave" == a.design_skin &&
                            (b.find(".dzsap-repeat-button").length
                                ? b.find(".dzsap-repeat-button").after(A)
                                : b.find(".dzsap-loop-button").length && 0 == b.find(".dzsap-loop-button").eq(0).parent().hasClass("feed-dzsap-for-extra-html-right")
                                ? b.find(".dzsap-loop-button").after(A)
                                : Rb.after(A),
                    ...
                    "skin-wave" == a.design_skin &&
                        ...
                        ("skin-wave" == a.design_skin
                            ...
                            : O.appendOnce('<div class="btn-menu-state"></div>'));
                    ...
                    "skin-wave" == a.design_skin &&
                        (da(),
                        "on" == a.skinwave_timer_static && (I && I.addClass("static"), N && N.addClass("static")),
                        ca.css({}),
                        "canvas" == a.skinwave_wave_mode &&
                            setTimeout(function () {
                                b.addClass("scrubbar-loaded");
                    ...
                    b.hasClass("skin-minion") &&
                        ...
                        (P.addClass("with-tooltip"),
                        P.prepend('<span class="dzstooltip" style="left:-7px;">' + b.find(".menu-description").html() + "</span>"),
                        P.children("span")
                            .eq(0)
                            .css("width", P.children("span").eq(0).textWidth() + 10));
                    "default" == a.player_navigation && (a.parentgallery && (a.player_navigation = "on"), a.parentgallery && a.parentgallery.hasClass("mode-showall") && (a.player_navigation = "off"));
                    "on" == a.disable_player_navigation && (a.player_navigation = "off");
                    "default" == a.player_navigation && (a.player_navigation = "off");
                    "on" == a.player_navigation &&
                        ((d =
                        ...
                        (e = d + h),
                        ("skin-wave" == a.design_skin && "small" == L) || "skin-aria" == a.design_skin
                            ? (P.before(d), P.after(h))
                            : "skin-wave" == a.design_skin
                            ? "on" == a.player_navigation && (Rb.prependOnce(d, ".prev-btn"), Rb.appendOnce(h, ".next-btn"))
                            : "skin-steel" == a.design_skin
                            ? (Aa.prependOnce(d, ".prev-btn"),
                              0 < Aa.children(".the-thumb-con").length
                                  ? 0 < Aa.children(".the-thumb-con").eq(0).length && 0 == Aa.children(".the-thumb-con").eq(0).prev().hasClass("next-btn") && Aa.children(".the-thumb-con").eq(0).before(h)
                                  : Aa.appendOnce(h, ".next-btn"))
                            : O.appendOnce(e, ".prev-btn"));
                    b.find(".extra-html-extra").length &&
                        ("" == a.settings_extrahtml && (a.settings_extrahtml = " "), (d = b.find(".extra-html-extra").eq(0).html()), d.length && ((a.settings_extrahtml = d), b.find(".extra-html-extra").eq(0).html("")));
                    ...
                    b.hasClass("skinvariation-wave-righter") && (ca.appendOnce('<div class="playbuttons-con"></div>'), b.find(".playbuttons-con").eq(0).append(b.find(".con-playpause-con")));
                    "skin-pro" == a.design_skin && (E.append(I), E.append(N));
                    "skin-silver" == a.design_skin && (w.after(E), Aa.prepend(A), Aa.append(I), E.append(N));
                    "skin-redlights" == a.design_skin &&
                        (E.append('<div class="ap-controls-right--top"></div>'),
                    ...
                    C &&
                        ...
                        mc.each(function () {
                            ...
                            "on" == a.skinwave_comments_process_in_php &&
                                b &&
                                b.hasClass &&
                                b.hasClass("dzstooltip-con") &&
                                !b.find(".dzstooltip > .dzstooltip--inner").length &&
                                (b.find(".dzstooltip").wrapInner('<div class="dzstooltip--inner"></div>'),
                ...
                function Ta() {
                    ...
                    0 == ob && A.find(".the-name").length && 0 < A.find(".the-artist").eq(0).text().length ? ((ob = !1), -1 < A.find(".the-name").eq(0).html().indexOf("&nbsp;&nbsp;") && (ob = !0)) : (ob = !0);
                    "on" == a.disable_scrub && b.addClass("disable-scrubbar");
                    "on" == a.design_animateplaypause && b.addClass("playing-animation");
                    "skin-wave" == a.design_skin &&
                        "" != a.embed_code &&
                        ("skin-wave" == a.design_skin
                            ? "on" == a.enable_embed_button &&
                              E &&
                              E.appendOnce(
                                  '<div class="btn-embed-code-con dzstooltip-con "><div class="btn-embed-code player-but"> <div class="the-icon-bg"></div>  <svg class="svg-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10.975px" height="14.479px" viewBox="0 0 10.975 14.479" enable-background="new 0 0 10.975 14.479" xml:space="preserve"> <g> <path d="M2.579,1.907c0.524-0.524,1.375-0.524,1.899,0l4.803,4.804c0.236-0.895,0.015-1.886-0.687-2.587L5.428,0.959 c-1.049-1.05-2.75-1.05-3.799,0L0.917,1.671c-1.049,1.05-1.049,2.751,0,3.801l3.167,3.166c0.7,0.702,1.691,0.922,2.587,0.686 L1.867,4.52c-0.524-0.524-0.524-1.376,0-1.899L2.579,1.907z M5.498,13.553c1.05,1.05,2.75,1.05,3.801,0l0.712-0.713 c1.05-1.05,1.05-2.75,0-3.8L6.843,5.876c-0.701-0.7-1.691-0.922-2.586-0.686l4.802,4.803c0.524,0.525,0.524,1.376,0,1.897 l-0.713,0.715c-0.523,0.522-1.375,0.522-1.898,0L1.646,7.802c-0.237,0.895-0.014,1.886,0.686,2.586L5.498,13.553z"/> </g> </svg> </div><span class="dzstooltip transition-slidein arrow-bottom align-right skin-black " style="width: 350px; "><span style="max-height: 150px; overflow:hidden; display: block;">' +
                                      a.embed_code +
                                      "</span></span></div>"
                              )
                            : "on" == a.enable_embed_button &&
                    ...
                    "on" == a.footer_btn_playlist &&
                        0 == E.find(".btn-footer-playlist").length &&
                        (E.append(
                    ...
                    "" != a.settings_extrahtml &&
                        (-1 < String(a.settings_extrahtml).indexOf("{{get_likes}}") && (fa++, nc()),
                        -1 < String(a.settings_extrahtml).indexOf("{{get_plays}}") ? (fa++, oc()) : 1 === Ua && (ib(), (Ua = 2)),
                        -1 < String(a.settings_extrahtml).indexOf("{{get_rates}}") && (fa++, pc()),
                        (a.settings_extrahtml = String(a.settings_extrahtml).replace(
                            "{{heart_svg}}",
                ...
                function Sb() {
                    b.hasClass("zoomsounds-wrapper-bg-bellow") &&
                        0 == b.find(".dzsap-wrapper-buts").length &&
                        (b.append('<div class="temp-wrapper"></div>'),
                ...
                function Q(d) {
                    ...
                    if (0 == ("on" == a.pcm_data_try_to_generate && "on" == a.pcm_data_try_to_generate_wait_for_real_pcm)) {
                        for (g = 0; 200 > g; g++) d[g] = Number(Math.random()).toFixed(2);
                        d = JSON.stringify(d);
                ...
                function R(b) {
                    var d = { prepare_for_transition_in: !1 };
                    b && (d = c.extend(d, b));
                ...
                function da() {
                    if ("on" != a.skinwave_enableSpectrum)
                        if ("canvas" == a.skinwave_wave_mode) b.attr("data-pcm") ? ((cb = !0), R()) : Q();
                        else {
                    ...
                    else R(), (Ca = b.find(".scrub-bg-img").eq(0)), Ca.get(0).getContext("2d");
                }
                function Ha(b, g, h, e) {
                    var d = { call_from: "default" };
                    e && (d = c.extend(d, e));
                    ...
                    if (!g) return setTimeout(function () {}, 1e3), !1;
                    if ("object" == typeof g) k = g;
                    else
                        try {
                            k = JSON.parse(g);
                        } catch (Ud) {}
                    var m = (g = 0);
                    for (g = 0; g < k.length; g++) k[g] > m && (m = k[g]);
                    var n = [];
                    for (g = 0; g < k.length; g++) n[g] = parseFloat(Math.abs(k[g]) / Number(m));
                    k = n;
                    b.width = w.width();
                    g = b.width;
                    b = b.height;
                    ...
                    for (g = 0; g < m; g++) {
                        ...
                        W
                            ? ((e.fillStyle = "#" + La),
                              v.length && ((p = e.createLinearGradient(0, 0, 0, b)), p.addColorStop(0, "#" + v[0]), p.addColorStop(1, "#" + v[1]), (e.fillStyle = p)),
                              ec && (g / m < aa / ma || g / m > eb / ma) && (e.fillStyle = f(Tb, 0)))
                            : ((e.fillStyle = h),
                              t.length &&
                                  ((p = e.createLinearGradient(0, 0, 0, b)), (t[0] = String(t[0]).replace("#", "")), (t[1] = String(t[1]).replace("#", "")), p.addColorStop(0, "#" + t[0]), p.addColorStop(1, "#" + t[1]), (e.fillStyle = p)),
                              ec && (g / m < aa / ma || g / m > eb / ma) && ((e.fillStyle = f(Tb, 0.5)), -1 < d.call_from.indexOf("pcm_prog") && (wb = !1)));
                    ...
                    if (0 < u)
                        for (g = 0; g < m; g++)
                            (wb = !0),
                                ...
                                "spectrum" == d.call_from && (W = g / m < H / B ? !0 : !1),
                                W
                                    ? ("reflecto" != a.skinwave_wave_mode_canvas_mode && (e.fillStyle = f(La, 0.25)),
                                      v.length &&
                                          ((p = e.createLinearGradient(0, 0, 0, b)),
                                          (l = f("#" + v[1], 0.25)),
                                          ...
                                          (e.fillStyle = p)))
                                    : ((e.fillStyle = h),
                                      "reflecto" != a.skinwave_wave_mode_canvas_mode && (e.fillStyle = f(h, 0.25)),
                                      t.length &&
                                          ((p = e.createLinearGradient(0, 0, 0, b)),
                                          (l = f("#" + t[1], 0.25)),
                ...
                function nc(d) {
                    d = { action: "dzsap_get_likes", postdata: d, playerid: D };
                    a.settings_php_handler &&
                        c.ajax({
                            type: "POST",
                            url: a.settings_php_handler,
                ...
                function pc(d) {
                    d = { action: "dzsap_get_rate", postdata: d, playerid: D };
                    a.settings_php_handler &&
                        c.ajax({
                            type: "POST",
                            url: a.settings_php_handler,
                            ...
                            success: function (d) {
                                ...
                                "undefined" != typeof d[2] &&
                                    ((Ga = d[2]), a.parentgallery && void 0 != c(a.parentgallery).get(0) && void 0 != c(a.parentgallery).get(0).api_player_rateSubmitted && c(a.parentgallery).get(0).api_player_rateSubmitted());
                                0 >= fa && b.find(".extra-html").addClass("active");
                            },
                            error: function (a) {
                                fa--;
                ...
                function oc(d) {
                    d = { action: "dzsap_get_views", postdata: d, playerid: D };
                ...
                function qa(d) {
                    d = { action: "dzsap_submit_rate", postdata: d, playerid: D };
                    -1 < Ga ||
                        (b.find(".star-rating-con").addClass("just-rated"),
                        a.settings_php_handler &&
                            c.ajax({
                                type: "POST",
                                url: a.settings_php_handler,
                ...
                function wa(b) {
                    b = { action: "dzsap_submit_download", postdata: b, playerid: D };
                    -1 < Ga || (a.settings_php_handler && c.ajax({ type: "POST", url: a.settings_php_handler, data: b, success: function (a) {}, error: function (a) {} }));
                }
                function ib(d) {
                    d = { action: "dzsap_submit_views", postdata: 1, playerid: D, currip: kd };
                ...
                function jb(d) {
                    d = { action: "dzsap_submit_like", postdata: d, playerid: D };
                ...
                function Ub(d) {
                    d = { action: "dzsap_retract_like", postdata: d, playerid: D };
                    b.find(".btn-like").addClass("disabled");
                    a.settings_php_handler &&
                        c.ajax({
                            type: "POST",
                ...
                function Da(d) {
                    var g = { do_not_autoplay: !1, call_from: "default" };
                    d && (g = c.extend(g, d));
                    if ("icecast" == y || "shoutcast" == y) y = "audio";
                    ...
                    if (1 != ab && "youtube" != b.attr("data-original-type")) {
                        ...
                        "youtube" == y &&
                            ("on" != a.settings_exclude_from_list && dzsap_list && -1 == dzsap_list.indexOf(b) && dzsap_list && "on" != b.attr("data-do-not-include-in-list") && dzsap_list.push(b),
                            dzsap_yt_list.push(b),
                            "change_media" == g.call_from && ((Ic = !1), m && m.destroy && (m.destroy(), console.log("DESTROYED LAST PLAYERS")), T.children().remove()),
                        ...
                        if ("audio" == y || "normal" == y || "soundcloud" == y)
                            (d = d + '<audio preload="' + (a.preload_method + '"')),
                                ...
                                (h = ""),
                                b.attr("data-source") &&
                                    ("icecast" != na && (xa = b.attr("data-source")),
                                    "fake" != xa
                                        ? ((h += '<source src="' + xa + '" type="audio/mpeg">'), void 0 != b.attr("data-sourceogg") && (h += '<source src="' + b.attr("data-sourceogg") + '" type="audio/ogg">'))
                                        : b.addClass("meta-loaded meta-fake")),
                                (qc = d + h + "</audio>"),
                                "change_media" == g.call_from
                                    ? (la && la.pause && la.pause(),
                                      ...
                                      is_ios() || is_android()
                                          ? m &&
                                            ...
                                            m.load && m.load())
                                          : (T.append(qc), (m = T.children("audio").get(0))))
                                    : (T.children().remove(),
                                      T.append(qc),
                                      (m = T.children("audio").get(0)),
                                      (is_ios() || is_android()) &&
                                          "retrieve_soundcloud_url" == g.call_from &&
                                          setTimeout(function () {
                                              Qa();
                                          }, 500)),
                                b.attr("data-soft-watermark") &&
                                    (T.append('<audio class="the-watermark" preload="metadata" loop><source src="' + b.attr("data-soft-watermark") + '" /></audio>'),
                                ...
                                m &&
                                    ...
                                    ((Pc = function (d) {
                                        ...
                                        if (this.networkState === HTMLMediaElement.NETWORK_NO_SOURCE && 0 == dzsap_is_mobile() && 0 == b.hasClass("errored-out"))
                                            if ((console.log("%c could not load audio source - ", "color:#ff2222;", b.attr("data-source")), 0 > ld))
                                                setTimeout(
                                                    function (a) {
                                                        m && (m.src = "");
                                                        setTimeout(function () {
                                                ...
                                                b.append('<div class="feedback-text"> <div class="wait-text"><p>Please wait while data is generated... <i class="fa fa-refresh" aria-hidden="true"></i></p></div> </div>');
                                            }
                                    }),
                                    ...
                                    m.addEventListener(
                                        ...
                                        function (a) {
                                            ...
                                            "change_media" == g.call_from && 0 == b.hasClass("init-loaded") && Ea({ call_from: "force_reload_change_media" });
                                        },
                                        !0
                                    ));
                        b.addClass("media-setuped");
                        if ("change_media" == g.call_from) return !1;
                        if ("youtube" != y) {
                            "fake" == b.attr("data-source")
                                ? (is_ios() || is_android()) && Ea(g)
                                : is_ios()
                                ? setTimeout(function () {
                                      Ea(g);
                                  }, 1e3)
                                : (Vb = setInterval(function () {
                                      var d = g,
                                          h = { do_not_autoplay: !1 };
                                      (a.fakeplayer && is_ios()) ||
                                          (d && (h = c.extend(h, d)),
                                          "youtube" == y
                                              ...
                                              : "undefined" != typeof m &&
                                                m &&
                                                ("AUDIO" != m.nodeName || "shoutcast" == a.type
                                                    ? Ea(h)
                                                    : is_safari()
                                                    ? 1 <= m.readyState && (Ea(h), clearInterval(Vb), a.action_audio_loaded_metadata && a.action_audio_loaded_metadata(b))
                                                    : 2 <= m.readyState && (Ea(h), clearInterval(Vb), a.action_audio_loaded_metadata && a.action_audio_loaded_metadata(b))));
                                  }, 50));
                            "none" == a.preload_method &&
                                setTimeout(function () {
                                    m && c(m).attr("preload", "metadata");
                                }, Number(window.dzsap_player_index) + 18e3);
                            if ("skin-customcontrols" == a.design_skin || "skin-customhtml" == a.design_skin) b.find(".custom-play-btn,.custom-pause-btn").off("click"), b.find(".custom-play-btn,.custom-pause-btn").on("click", md);
                            a.failsafe_repair_media_element &&
                                (setTimeout(function () {
                                    if (T.children().eq(0).get(0) && "AUDIO" == T.children().eq(0).get(0).nodeName) return !1;
                                    T.html("");
                                    T.append(qc);
                                    var a = ta;
                                    Qa();
                ...
                function Rc() {
                    ...
                    if ("skin-silver" == a.design_skin) b.on("click", ".volume-holder", rc);
                ...
                function Ea(d) {
                    ...
                    if (!b.hasClass("dzsap-loaded")) {
                        var g = { do_not_autoplay: !1, call_from: "init" };
                        d && (g = c.extend(g, d));
                        setTimeout(function () {
                            od = !0;
                        }, 5e3);
                        ...
                        d = null;
                        b.parent().hasClass("vc_tta-panel-body")
                            ? (d = b.parent())
                            : (b.parent().parent().parent().hasClass("vc_tta-panel-body") && (d = b.parent().parent().parent()),
                        ...
                        hd && ((Ob = !0), ua({ call_from: "pcm_data_try_to_generate .. no data-pcm" }));
                        "fake" != y &&
                            "force_reload_change_media" != g.call_from &&
                            ("on" != a.settings_exclude_from_list && dzsap_list && -1 == dzsap_list.indexOf(b) && null == a.fakeplayer && dzsap_list.push(b),
                        ...
                        if (
                            ...
                            (null == window.dzsap_audio_ctx
                                ? "undefined" !== typeof AudioContext
                                    ? ((F = new AudioContext()), (window.dzsap_audio_ctx = F))
                                    : "undefined" !== typeof webkitAudioContext
                                    ? ((F = new webkitAudioContext()), (window.dzsap_audio_ctx = F))
                                    : (F = null)
                                : (F = window.dzsap_audio_ctx),
                            F)
                        )
                        ...
                        0 == isNaN(Number(a.default_volume))
                            ? (xb = Number(a.default_volume))
                            : "last" == a.default_volume && (xb = null != localStorage && D ? (localStorage.getItem("dzsap_last_volume_" + D) ? localStorage.getItem("dzsap_last_volume_" + D) : 1) : 1);
                        a.volume_from_gallery && (xb = a.volume_from_gallery);
                        db(xb, { call_from: "from_init_loaded" });
                        Z && (V = Z);
                        "number" == typeof V && 0 == Math.round(V) % 1 && oa(V, { call_from: "from_playfrom" });
                        "last" == V &&
                            "undefined" != typeof Storage &&
                            (setTimeout(function () {
                                Vc = !0;
                            }),
                            "undefined" != typeof localStorage["dzsap_" + D + "_lastpos"] && oa(localStorage["dzsap_" + D + "_lastpos"], { call_from: "last_pos" }));
                        1 != g.do_not_autoplay && "on" == a.autoplay && "on" == a.cue && Y({ call_from: "do not autoplay not true ( init_loaded() ) " });
                        m && m.duration && b.addClass("meta-loaded");
                        sa({ fire_only_once: !1 });
                        "off" == a.autoplay && (Ib = !0);
                        b.addClass("init-loaded");
                        setTimeout(function () {
                            uc({ call_from: "set timeout 500" });
                            sa({ fire_only_once: !0 });
                            b.find(".wave-download").bind("click", ub);
                        }, 500);
                        setTimeout(function () {
                            uc({ call_from: "set timeout 1000" });
                            h && (B = h.duration);
                            sa({ fire_only_once: !0 });
                        }, 1e3);
                ...
                function Lc() {
                    for (var a = [], b = 0; 256 > b; b++) a[b] = 100 * Math.random();
                    return a;
                }
                function Qd(a) {
                ...
                function ub(d) {
                    ...
                    if ("click" == d.type) {
                        ...
                        if (g.hasClass("playlist-menu-item")) {
                            ...
                            console.log("ind - ", h);
                            ba(h, { call_from: "handle_mouse" });
                        }
                        g.hasClass("zoomsounds-btn-go-beginning") && ((h = b), a.fakeplayer && (h = a.fakeplayer), h.get(0).api_seek_to_0());
                        ...
                        g.hasClass("dzsap-repeat-button") && oa(0, { call_from: "repeat" });
                    ...
                    "mouseenter" == d.type && ("on" == a.preview_on_hover && (Xb(0), Y({ call_from: "preview_on_hover" }), console.log("mouseover")), (window.dzsap_mouseover = !0));
                ...
                function Xc(a) {
                    ...
                    if (0 != b.has(d).length) {
                        if ("mouseleave" == a.type) {
                            ...
                            b.find(".rating-prog").css({ width: h + "%" });
                        }
                        "mousemove" == a.type &&
                            ((h = a.pageX - d.offset().left),
                            d.offset(),
                            (Va = Math.round(h / (d.outerWidth() / 5))),
                            (Va = 4 < Va ? 5 : Math.round(Va)),
                            1 > Va && (Va = 1),
                            b.find(".rating-prog").css({ width: (Va / 5) * 100 + "%" }),
                            (Ga = -1),
                ...
                function Yc() {
                    if ("skin-wave" == a.design_skin) {
                        if ("on" == a.skinwave_enableSpectrum) {
                            ...
                            if ($c) {
                                if (0 == M[0] && 0 == M[Math.round(M.length / 4)] && 0 == M[Math.round(M.length / 2)] && 0 == M[Math.round(M.length / 3 / 4)]) "auto" == Zb && ((Zb = "on"), (sd = "lastarray0"));
                                else if ("auto" == Zb || "lastarray0" == sd) Zb = "off";
                                $c = !1;
                            }
                            if (M && M.length) {
                                for (var d = M.length, c = d - 1; 0 <= c; c--) M[c] = c < d / 2 ? (M[c] / 255) * Yb : (M[d - c] / 255) * Yb;
                                if (wc) for (d = 0; d < wc.length; d++) (ad = wc[d]), (td = M[d] - ad), (ud = 3), (M[d] = Math.easeIn(1, ad, td, ud));
                                Ha(Ca.get(0), M, "" + a.design_wave_color_bg, { call_from: "spectrum" });
                                M && (wc = M.slice());
                            }
                        }
                        if (I && I.length && "on" != a.skinwave_timer_static) {
                            0 > K && (K = 0);
                            K = parseInt(K, 10);
                            if (2 > K && b.data("promise-to-play-footer-player-from")) return !1;
                            I.css({ left: K });
                            K > G - Tc && I.css({ left: G - Tc });
                            K > G - 30 && G ? N.css({ opacity: 1 - (K - (G - 30)) / 30 }) : "1" != N.css("opacity") && N.css({ opacity: "" });
                        }
                    }
                    I &&
                        (0 == bd && I.html(vb(ha)),
                        U && -1 < U && (b.addClass("time-total-visible"), 0 == vd && (a.action_received_time_total && a.action_received_time_total(U, b), (vd = !0))),
                        U != wd && (N.html(vb(U)), N.fadeIn("fast")));
                }
                function $b() {
                    0 == B && (B = U);
                    K = (H / B) * G;
                ...
                function uc(b) {
                    var d = { call_from: "default" };
                    b && c.extend(d, b);
                    ("audio" == y || ("fake" == y && a.fakeplayer)) &&
                        "shoutcast" != a.type &&
                        (m && ((pb = m.duration), null == a.fakeplayer && (Wa = m.currentTime)),
                        a.fakeplayer && (H = ha),
                        F && is_firefox(),
                ...
                function sa(d) {
                    ...
                    d && (g = c.extend(g, d));
                    if (Hb) return console.warn("DESTROYED"), !1;
                    if (0 == g.fire_only_once && Ib) return requestAnimFrame(sa), !1;
                    Wa = pb = -1;
                    if ("youtube" == y)
                        try {
                            m && m.getDuration && ((pb = m.getDuration()), null == a.fakeplayer && (Wa = m.getCurrentTime())), "last" == V && Vc && "undefined" != typeof Storage && (localStorage["dzsap_" + D + "_lastpos"] = Wa);
                        } catch (Ld) {
                            console.log("yt error - ", Ld);
                        }
                    uc({ call_from: "checK_time" });
                    -1 < Wa && (ha = H = Wa);
                    -1 < pb && (U = B = pb);
                        ...
                        C &&
                            C.children().each(function () {
                                ...
                                if (a.hasClass("dzstooltip-con")) {
                                    ...
                                    b.attr("id");
                                    d && (0.02 > Math.abs(d - h) ? (C.find(".dzstooltip").removeClass("active"), a.find(".dzstooltip").addClass("active")) : a.find(".dzstooltip").removeClass("active"));
                                }
                            });
                    }
                    Z &&
                        ...
                        Xa &&
                            H > Xa &&
                            ((d = { call_from: "time_curr>pseudo_sample_time_end" }),
                            sc(d),
                            (kb = !0),
                            clearTimeout(ac),
                    ...
                    q &&
                        (q.get(0) &&
                            q.get(0).api_get_time_curr &&
                            ((isNaN(q.get(0).api_get_time_total()) || "" == q.get(0).api_get_time_total() || 1 > q.get(0).api_get_time_total()) && q.get(0).api_set_time_total(U), q.get(0).api_set_time_curr(H)),
                        q.get(0) && q.get(0).api_seek_to_visual ? ((d = H), 0 == Z && aa && (d -= aa), q.get(0).api_seek_to_visual(d / B)) : console.log("warning .. no seek to visual"));
                    if ("skin-minimal" == a.design_skin)
                        if (yd)
                            ...
                            } else return 1 != g.fire_only_once && requestAnimFrame(sa), !1;
                        else P.addClass("canvas-fallback");
                    Yc();
                    od &&
                        1 < B &&
                        H >= B - 0.07 &&
                        ((d = { call_from: "time_total > 0 && time_curr >= time_total - 0.07 ... " }),
                        a.fakeplayer ||
                            (sc(d),
                            (kb = !0),
                            clearTimeout(ac),
                ...
                function md(d) {
                    ...
                    if (!b.hasClass("listeners-setuped")) {
                        ...
                        var e = setInterval(function () {
                            m && m.duration && 0 == isNaN(m.duration) && ((B = Dc = m.duration), b.addClass("meta-loaded"), N && N.html(vb(U)), clearInterval(e));
                        }, 1e3);
                    }
                    if ("skin-minimal" == a.design_skin) {
                        ...
                        var k = d.pageX;
                        d = d.pageY;
                        var l = 0.005 * -(k - f - Ma / 2);
                        d < g && (l = 0.5 + (0.5 - l));
                        if (20 < Math.abs(d - g) || 20 < Math.abs(k - f)) Xb(l, { call_from: "skin_minimal_scrub" }), (h = !0), sa({ fire_only_once: !0 });
                    }
                    0 == h && (0 == ta ? Y({ call_from: "click_playpause" }) : Qa());
                    return !1;
                }
                function rd() {
                    if (a.fakeplayer) return a.fakeplayer.get(0).api_sync_players_goto_prev(), !1;
                    if (ea && ea.children(".dzstooltip--inner").length) {
                        var d = ic - 1;
                        0 <= d && ba(d, { call_from: "api_sync_players_prev" });
                        ...
                        for (d in dzsap_list_for_sync_players) {
                            ...
                            if (dzsap_list_for_sync_players[d].get(0) == c.get(0) && ((d = parseInt(d, 10)), 0 < d)) {
                                ...
                                h &&
                                    h.api_play_media &&
                                    setTimeout(function () {
                                        h.api_play_media({ call_from: "api_sync_players_prev" });
                                    }, 200);
                            }
                        }
                }
                function Wc() {
                    if (a.fakeplayer) return a.fakeplayer.get(0).api_sync_players_goto_next(), !1;
                    if (ea && ea.find(".playlist-menu-item").length) {
                        var d = ic + 1;
                        d - 1 > ea.find(".playlist-menu-item").length || ba(d, { call_from: "api_sync_players_prev" });
                ...
                function sc(d) {
                    ...
                    if (a.fakeplayer && "fake_player" != g.call_from) return !1;
                    oa(0, { call_from: "handle_end" });
                    if ("on" == a.loop || vc) return Y({ call_from: "track_end" }), !1;
                    Qa();
                    ...
                    setTimeout(function () {
                        if (q && (q.hasClass("is-single-player") || q.hasClass("feeded-whole-playlist"))) return q.get(0).api_handle_end({ call_from: "handle_end fake_player" }), !1;
                        xc && xc(b, {});
                    }, 200);
                }
                function Pa(d, g) {
                    ...
                    500 >= pa
                        ? (0 == b.hasClass("under-500") && "skin-wave" == a.design_skin && "normal" == L && ca.append(A), b.addClass("under-500"))
                        : (0 == b.hasClass("under-500") && "skin-wave" == a.design_skin && "normal" == L && Rb.after(A), b.removeClass("under-500"));
                    G = pa;
                    "skin-default" == a.design_skin && (G = pa);
                    "skin-pro" == a.design_skin && (G = pa);
                    if ("skin-silver" == a.design_skin || "skin-aria" == a.design_skin) (G = pa), (G = w.width());
                    "skin-justthumbandbutton" == a.design_skin && (G = pa = b.children(".audioplayer-inner").outerWidth());
                    if ("skin-redlights" == a.design_skin || "skin-steel" == a.design_skin) G = w.width();
                    "skin-wave" == a.design_skin &&
                        ((G = w.outerWidth(!1)),
                        w.outerHeight(!1),
                        C &&
                            ...
                            C.css({ width: G }),
                            b.hasClass("skin-wave-mode-small") && C.css({ left: g + "px" }),
                            C.addClass("active")));
                    1 == zd &&
                        ("skin-default" == a.design_skin &&
                            (void 0 != b.get(0) && "auto" == b.get(0).style.height && b.height(200),
                            O.height(),
                    ...
                    "none" != b.css("display") &&
                        ...
                        w
                            .find(".scrub-prog-img")
                            .eq(0)
                            .css({ width: w.children(".scrub-bg").width() }),
                        w
                    ...
                    if ("skin-wave" == a.design_skin) {
                        ...
                        if (A && "none" != A.css("display")) {
                            if ("skin-wave" != a.design_skin || "small" != L) A.css({}), "skin-wave" == a.design_skin && "small" != L && A.css({});
                            lb += A.outerWidth();
                        }
                        J && J.css("display");
                        "small" == L && (w.css({}), (G = w.width()), w.find(".scrub-bg--img").eq(0).css({ width: G }), w.find(".scrub-prog--img").eq(0).css({ width: G }));
                        "canvas" == a.skinwave_wave_mode && b.attr("data-pcm") && (100 == Za.width() && Za.width(w.width()), Za && id && ca.parent(), "fake" != xa && (bc ? (clearTimeout(bc), (bc = setTimeout(Bd, 500))) : (Bd(), (bc = 1))));
                    }
                    "skin-minimal" == a.design_skin && ((Ma = ca.width()), Fa && ((Fa.style.width = Ma), (Fa.width = Ma), (Fa.style.height = Ma), (Fa.height = Ma), c(Fa).css({ width: Ma, height: Ma })));
                    "skin-default" == a.design_skin && I && ((g = parseInt(A.css("left"), 10)), A.outerWidth(), A.css("display"), isNaN(g));
                    "skin-minion" == a.design_skin &&
                        ((g = parseInt(Ka.find(".con-playpause").eq(0).offset().left, 10) - parseInt(Ka.eq(0).offset().left, 10) - 18),
                        Ka.find(".prev-btn").eq(0).css({ top: 0, left: g }),
                        (g += 36),
                        Ka.find(".next-btn").eq(0).css({ top: 0, left: g }));
                    "on" == a.embedded &&
                        window.frameElement &&
                        ((g = { height: b.outerHeight() }), a.embedded_iframe_id && (g.embedded_iframe_id = a.embedded_iframe_id), window.parent.postMessage({ name: "resizeIframe", params: g }, "*"));
                    $b();
                ...
                function Ad() {
                    a.restyle_player_over_400 &&
                        ...
                        (yb
                            ? (console.log("RESTYLING WITH CLASS -> ", a.restyle_player_under_400), b.removeClass(a.restyle_player_over_400), b.addClass(a.restyle_player_under_400))
                            : (console.log("RESTYLING WITH CLASS -> ", a.restyle_player_over_400), b.removeClass(a.restyle_player_under_400), b.addClass(a.restyle_player_over_400)),
                        r(),
                        tb(),
                        ...
                        yb
                            ? (console.log("RESTYLING WITH CLASS -> ", a.restyle_player_under_400), b.removeClass(a.restyle_player_over_400), b.addClass(a.restyle_player_under_400))
                            : (b.css({ "padding-top": "" }), console.log("RESTYLING WITH CLASS -> ", a.restyle_player_over_400), b.removeClass(a.restyle_player_under_400), b.addClass(a.restyle_player_over_400)),
                        S({ setup_inner_player: !1, setup_media: !1, setup_otherstructure: !0, call_from: "reconstruct" }),
                        Rc());
                }
                function Bd() {
                    Ha(Za.get(0), b.attr("data-pcm"), "#" + a.design_wave_color_bg, { call_from: "canvas_normal_pcm_bg" });
                    Ha($a.get(0), b.attr("data-pcm"), "#" + a.design_wave_color_progress, { call_from: "canvas_normal_pcm_prog" });
                    bc = 0;
                }
                function rc(d) {
                    var g = c(this);
                    "mousemove" == d.type &&
                        ...
                        "skin-redlights" == a.design_skin && ((e *= 10), (e = Math.round(e)), (e /= 10)),
                        db(e, { call_from: "set_by_mousemove" }),
                        (zb = !1));
                    "click" == d.type &&
                        ((e = (d.pageX - J.find(".volume_static").eq(0).offset().left) / J.find(".volume_static").eq(0).width()),
                        g.parent().hasClass("volume-holder") && (e = 1 - (d.pageY - J.find(".volume_static").eq(0).offset().top) / J.find(".volume_static").eq(0).height()),
                        g.hasClass("volume-holder") && ((e = 1 - (d.pageY - J.find(".volume_static").eq(0).offset().top) / J.find(".volume_static").eq(0).height()), console.log(e)),
                        db(e, { call_from: "set_by_mouseclick" }),
                        (zb = !1));
                    "mousedown" == d.type &&
                        ((cd = !0),
                        ...
                        (e = (d.pageX - J.find(".volume_static").eq(0).offset().left) / J.find(".volume_static").eq(0).width()),
                        g.parent().hasClass("volume-holder") && (e = 1 - (d.pageY - J.find(".volume_static").eq(0).offset().top) / J.find(".volume_static").eq(0).height()),
                        db(e, { call_from: "set_by_mousedown" }),
                        (zb = !1));
                    "mouseup" == d.type && ((cd = !1), b.removeClass("volume-dragging"));
                }
                function Sc(d) {
                    var g = d.pageX;
                    if (c(d.target).hasClass("sample-block-start") || c(d.target).hasClass("sample-block-end")) return !1;
                    if ("mousemove" == d.type && (w.children(".scrubBox-hover").css({ left: g - w.offset().left }), "on" == a.scrub_show_scrub_time && B)) {
                        var h = ((g - w.offset().left) / w.outerWidth()) * B;
                        I && (I.html(vb(h)), I.addClass("scrub-time"));
                        bd = !0;
                    }
                    "mouseleave" == d.type && ((bd = !1), I && I.removeClass("scrub-time"), Yc());
                    if (
                        "click" == d.type &&
                        (b.hasClass("prevent-bubble") && d && d.stopPropagation && (d.preventDefault(), d.stopPropagation()),
                        0 == G && (G = w.width()),
                        ...
                        a.fakeplayer &&
                            setTimeout(function () {
                                a.fakeplayer.get(0) && a.fakeplayer.get(0).api_pause_media && a.fakeplayer.get(0).api_seek_to_perc(h / B, { call_from: "from_feeder_to_feed" });
                            }, 50),
                        oa(h, { call_from: "handle_mouse_scrubbar" }),
                        "on" == a.autoplay_on_scrub_click && 0 == ta && Y({ call_from: "handle_mouse_scrubbar" }),
                ...
                function oa(d, g) {
                    var h = { call_from: "default", deeplinking: "off", call_from_type: "default" };
                    g && (h = c.extend(h, g));
                    0 == d && (H = 0);
                    dd && (dd = !1);
                    "on" == h.deeplinking && ((g = add_query_arg(window.location.href, "audio_time", d)), history.pushState({ foo: "bar" }, null, g));
                    d = xd(d);
                    Z && (d < Z && (d = Z), d > Xa && (d = Xa));
                    if (a.fakeplayer)
                        return (
                            (g = { type: cc, fakeplayer_is_feeder: "on" }),
                            a.fakeplayer.length &&
                                a.fakeplayer.data("feeding-from") != b.get(0) &&
                                ("handle_end" != h.call_from && "from_playfrom" != h.call_from && "last_pos" != h.call_from
                                    ? ((g.call_from = "seek_to from player source->" + b.attr("data-source") + " < -  old call from - " + h.call_from), a.fakeplayer.get(0).api_change_media(b, g))
                                    : ((Wa = ha = H = d), b.data("promise-to-play-footer-player-from", d))),
                            setTimeout(function () {
                                a.fakeplayer.get(0) && a.fakeplayer.get(0).api_pause_media && "from_playfrom" != h.call_from && "last_pos" != h.call_from && a.fakeplayer.get(0).api_seek_to(d, { call_from: "from_feeder_to_feed" });
                            }, 50),
                            !1
                        );
                    if ("youtube" == y)
                ...
                function db(d, g) {
                    ...
                    if ("set_by_mouseclick" == h.call_from || "set_by_mousemove" == h.call_from) yc = !0;
                    ...
                    a.fakeplayer &&
                        "from_fake_player" != h.call_from &&
                        ((h.call_from = "from_init_loaded" == h.call_from ? "from_fake_player_feeder_from_init_loaded" : "from_fake_player_feeder"),
                        q && q.get(0) && q.get(0).api_set_volume(d, h) && a.fakeplayer.get(0).api_set_volume(d, h));
                }
                function Cd(d, c) {
                    J.hasClass("controls-volume-vertical")
                        ? J.find(".volume_active")
                              .eq(0)
                              .css({ height: J.find(".volume_static").eq(0).height() * d })
                        : J.find(".volume_active")
                              .eq(0)
                              .css({ width: J.find(".volume_static").eq(0).width() * d });
                    "skin-wave" == a.design_skin &&
                ...
                function Md(a) {
                    0 == zb ? ((Dd = Gb), db(0, { call_from: "from_mute" }), (zb = !0)) : (db(Dd, { call_from: "from_unmute" }), (zb = !1));
                }
                function Ed(d) {
                    var g = { call_from: "default" };
                    d && c.extend(g, d);
                    "on" != a.design_animateplaypause && (P.children(".playbtn").css({ display: "block" }), P.children(".pausebtn").css({ display: "none" }));
                ...
                function Qa(d) {
                    ...
                    if (Hb) return !1;
                    d && (g = c.extend(g, d));
                    Ed({ call_from: "pause_media" });
                    1 != g.donot_change_media && null != a.fakeplayer
                        ? ((d = { type: cc, fakeplayer_is_feeder: "on" }),
                          a.fakeplayer && a.fakeplayer.length && a.fakeplayer.data("feeding-from") != b.get(0) && ((d.call_from = "pause_media from player " + b.attr("data-source")), a.fakeplayer.get(0).api_change_media(b, d)),
                          setTimeout(function () {
                              a.fakeplayer.get(0) && a.fakeplayer.get(0).api_pause_media && a.fakeplayer.get(0).api_pause_media();
                          }, 100))
                        : ("youtube" == y && m && m.pauseVideo && m.pauseVideo(),
                          "audio" == y && (m && ("stop" == a.pause_method ? (m.pause(), (m.src = ""), La(), c(m).remove(), (m = null)) : m.pause && m.pause()), la && la.pause && la.pause()),
                          q && q.get(0).api_pause_media_visual({ call_from: "pause_media in child player" }));
                    ta = !1;
                    b.removeClass("is-playing");
                    b.parent().hasClass("zoomsounds-wrapper-bg-center") && b.parent().removeClass("is-playing");
                }
                function Ec(d) {
                    "on" != a.design_animateplaypause && (P.children(".playbtn").css({ display: "none" }), P.children(".pausebtn").css({ display: "block" }));
                    ta = !0;
                    Ib = !1;
                ...
                function Y(d) {
                    var g = { api_report_play_media: !0, call_from: "default", retry_call: 0 };
                    d && (g = c.extend(g, d));
                    Qc || Da();
                    "api_sync_players_prev" == g.call_from &&
                        ((Fd = b.parent().children(".audioplayer,.audioplayer-tobe").index(b)), a.parentgallery && a.parentgallery.get(0) && a.parentgallery.get(0).api_goto_item && a.parentgallery.get(0).api_goto_item(Fd));
                    is_ios();
                    ...
                    for (Na = 0; Na < dzsap_list.length; Na++)
                        dzsap_list[Na].get(0) &&
                            ...
                            dzsap_list[Na].get(0) != b.get(0) &&
                            (dzsap_list[Na].data("type_audio_stop_buffer_on_unfocus") && "on" == dzsap_list[Na].data("type_audio_stop_buffer_on_unfocus")
                                ? dzsap_list[Na].get(0).api_destroy_for_rebuffer()
                                : dzsap_list[Na].get(0).api_pause_media({ audioapi_setlasttime: !1 }));
                    Uc && (Da(), "number" == typeof V && 0 == Math.round(V) % 1 && oa(V, { call_from: "destroyed_for_rebuffer_playfrom" }), (Uc = !1));
                    "on" == a.google_analytics_send_play_event && window._gaq && 0 == Bc && (window._gaq.push(["_trackEvent", "ZoomSounds Play", "Play", "zoomsounds play - " + Ya]), (Bc = !0));
                    !window.ga && window.__gaTracker && (window.ga = window.__gaTracker);
                    "on" == a.google_analytics_send_play_event &&
                        window.ga &&
                        0 == Bc &&
                        (window.console && console.log("sent event"), (Bc = !0), window.ga("send", { hitType: "event", eventCategory: "zoomsounds play - " + Ya, eventAction: "play", eventLabel: "zoomsounds play - " + Ya }));
                    q && q.get(0).api_play_media_visual({ api_report_play_media: !1 });
                    if (a.fakeplayer) {
                        d = { type: cc, fakeplayer_is_feeder: "on", call_from: "play_media_audioplayer" };
                        try {
                            ...
                            a.fakeplayer &&
                                a.fakeplayer.length &&
                                a.fakeplayer.data("feeding-from") != b.get(0) &&
                                ((d.call_from = "play_media from player " + b.attr("data-source") + " < -  old call from - " + g.call_from),
                                a.fakeplayer.get(0).api_change_media(b, d),
                                0 == b.hasClass("first-played") &&
                                    b.data("promise-to-play-footer-player-from") &&
                                    (oa(b.data("promise-to-play-footer-player-from")),
                                    setTimeout(function () {
                                        b.data("promise-to-play-footer-player-from", "");
                                    }, 1e3)));
                            setTimeout(function () {
                                a.fakeplayer.get(0) && a.fakeplayer.get(0).api_play_media && a.fakeplayer.get(0).api_play_media({ call_from: "feed_to_feeder" });
                            }, 100);
                            "off" == ia && ib();
                            return;
                        } catch (h) {
                ...
                "default" == a.skinwave_preloader_code &&
                    (a.skinwave_preloader_code =
                ...
                (function () {
                    ...
                    if (b.hasClass("dzsap-inited")) return !1;
                    ...
                    "skin-justthumbandbutton" == a.design_skin &&
                        ("default" == a.design_thumbh && (a.design_thumbh = ""), (a.disable_timer = "on"), (a.disable_volume = "on"), "default" == a.design_animateplaypause && (a.design_animateplaypause = "on"));
                    ...
                    "reflecto" == a.skinwave_wave_mode_canvas_mode && (a.skinwave_wave_mode_canvas_reflection_size = 0.5);
                    "reflecto" == a.skinwave_wave_mode_canvas_mode && (reflection_size = 0.5);
                    ...
                    "" == a.skinwave_comments_playerid
                        ? ("undefined" != typeof b.attr("id") && (D = b.attr("id")), b.attr("data-playerid") && (D = b.attr("data-playerid")))
                        : ((D = a.skinwave_comments_playerid), b.attr("id") || b.attr("id", D));
                    ...
                    b.attr("data-fakeplayer") &&
                        ((d = c(b.attr("data-fakeplayer"))),
                        0 == d.length &&
                            ((d = c(String(b.attr("data-fakeplayer")).replace("#", "."))),
                            d.length && ((a.fakeplayer = c(String(b.attr("data-fakeplayer")).replace("#", "."))), b.attr("data-fakeplayer", String(b.attr("data-fakeplayer")).replace("#", ".")))),
                        0 == d.length
                            ? b.attr("data-fakeplayer", "")
                            : (b.addClass("player-is-feeding"), b.attr("data-type") && ((a.fakeplayer = c(b.attr("data-fakeplayer")).eq(0)), (cc = b.attr("data-type")), b.attr("data-original-type", cc))));
                    b.addClass("scrubbar-type-" + a.scrubbar_type);
                    0 < b.children(".extra-html").length &&
                        "" == a.settings_extrahtml &&
                        ((a.settings_extrahtml = b.children(".extra-html").eq(0).html()),
                        (mb = b.children(".extra-html").eq(0)),
                        (d = /{\{ratesubmitted=(.?)}}/g),
                        d.test(String(a.settings_extrahtml)) &&
                            ((d.lastIndex = 0),
                    ...
                    "on" == a.construct_player_list_for_sync &&
                        0 == dzsap_list_for_sync_sw_built &&
                    ...
                    "shoutcast" == b.attr("data-type") && ((a.type = "shoutcast"), (y = "audio"), (a.disable_timer = "on"), (a.skinwave_enableSpectrum = "off"), "skin-default" == a.design_skin && (a.disable_scrub = "on"));
                    "" == y && (y = "audio");
                    na = "";
                    if ("normal" == y || "audio" == y) b.attr("data-streamtype") && "off" != b.attr("data-streamtype") ? ((na = b.attr("data-streamtype")), b.attr("data-source"), b.addClass("is-radio-type")) : (na = "");
                    bb = b.attr("data-source");
                    ...
                    if (!b.hasClass("audioplayer")) {
                        ...
                        0 < b.find(".the-comments").length && 0 < b.find(".the-comments").eq(0).children().length
                            ? (mc = b.find(".the-comments").eq(0).children())
                            : "on" == a.skinwave_comments_retrievefromajax &&
                              ((d = { action: "dzsap_get_comments", postdata: "1", playerid: D }),
                              a.settings_php_handler &&
                                  c.ajax({
                                      type: "POST",
                                      url: a.settings_php_handler,
                                      ...
                                      success: function (a) {
                                          ...
                                          -1 < a.indexOf("a-comment") &&
                                              ((a = a.replace(/a-comment/g, "a-comment dzstooltip-con")), (a = a.replace(/dzstooltip arrow-bottom/g, "dzstooltip arrow-from-start transition-slidein arrow-bottom")));
                                          b.find(".the-comments").eq(0).html(a);
                                          mc = b.find(".the-comments").eq(0).children();
                                          Ba({ call_from: "ajax_complete" });
                                      },
                                      error: function (a) {},
                                  }));
                        "skin-wave" == a.design_skin && "canvas" == a.skinwave_wave_mode && Eb();
                        if (is_ios() || is_android()) (a.autoplay = "off"), (a.disable_volume = "on"), "off" == a.cue && (a.cue = "on"), (a.cue = "on");
                        ...
                        else b.find(".playbtn").bind("click", hb), b.find(".scrubbar").bind("click", hb), Pa();
                        setInterval(function () {
                            $c = !0;
                        }, 3e3);
                        setInterval(function () {
                        ...
                        ja &&
                            (b.hasClass("theme-dark") && ja.addClass("theme-dark"),
                            setTimeout(function () {
                                ja.addClass("inited");
                            }, 500),
                            ja.addClass("dzsap-sticktobottom-for-" + a.design_skin),
                            ja.prev().addClass("dzsap-sticktobottom-for-" + a.design_skin),
                            "skin-wave" == a.design_skin && (ja.addClass("dzsap-sticktobottom-for-" + a.design_skin + "--mode-" + L), ja.prev().addClass("dzsap-sticktobottom-for-" + a.design_skin + "--mode-" + L)),
                            (Id = b.attr("class")),
                            (d = /(skinvariation-.*?)($| )/g.exec(Id)) && d[1] && (ja.addClass(d[1]), ja.prev().addClass(d[1])));
                        ...
                        b.get(0).api_playback_slow = function (a) {
                            console.log(m);
                            m && m.playbackRate && (m.playbackRate = 0.65);
                        };
                        ...
                        sa({ fire_only_once: !0 });
                        setInterval(u, 500);
                        "skin-minimal" == a.design_skin && sa({ fire_only_once: !0 });
                        b.on(
                            "click",
                        ...
                        c(document).on("touchmove", function (a) {
                            if (fd) return (Jd = a.originalEvent.touches[0].pageX), (Ab = Jd - w.offset().left), 0 > Ab && (Ab = 0), Ab > w.width() && (Ab = w.width()), Xb(Ab / w.width()), !1;
                        });
                        c(document).on("touchend", function (a) {
                            fd = !1;
                        });
                        a.skinwave_comments_mode_outer_selector &&
                            ((Ra = c(a.skinwave_comments_mode_outer_selector)),
                            Ra.data
                                ? (Ra.data("parent", b),
                                  ...
                                  Ra.on("focusout", "input", l))
                                : console.log("%c, data not available .. ", "color: #990000;", c(a.skinwave_comments_mode_outer_selector)));
        ...
        c.fn.zoomsounds_nav = function (a) {
            "undefined" == typeof a && "undefined" != typeof c(this).attr("data-options") && "" != c(this).attr("data-options") && ((a = c(this).attr("data-options")), eval("var aux_opts = " + a), (a = aux_opts));
            a = c.extend({}, a);
            this.each(function () {
                c(this).children();
            });
        ...
        c.fn.audiogallery = function (a) {
            ...
            this.each(function () {
                ...
                function n() {
                    if (oc) return !1;
                    oc = !0;
                    var e = { action: "dzsap_get_views_all", postdata: "1" };
                    a.settings_php_handler &&
                        c.ajax({
                            type: "POST",
                            url: a.settings_php_handler,
                ...
                function r() {
                    if (t.attr("data-track-data")) {
                        ...
                        wa &&
                            wa.length &&
                            (Q.find(".menu-item-views").each(function () {
                                var e = c(this),
                                    f = e.html(),
                                    k = /{{views_(.*?)}}/g.exec(f);
                                if (k && k[1]) {
                ...
                function v() {
                    ...
                    for (S = 0; S < a; S++) {
                        ...
                        qa.push({ menu_description: e, player_id: f });
                        x.append(c);
                    }
                    for (S = 0; S < qa.length; S++)
                        (a = ""),
                            ...
                            t.hasClass("skin-aura") &&
                                1 == String(qa[S].menu_description).indexOf("menu-item-views") &&
                                (wa && 0 < wa.length
                                    ? (a += '<div class="menu-item-views"></div>')
                                    : (n(),
                                      (a +=
                ...
                function Cb() {
                    if (0 == c(this).hasClass("active")) return alert(ib), !1;
                }
                function Db() {
                    "undefined" != typeof x.children().eq(z).get(0) && "undefined" != typeof x.children().eq(z).get(0).api_play_media && x.children().eq(z).get(0).api_play_media({ call_from: "play_curr_media_gallery" });
                }
                function hc(c) {
                ...
                function jc() {
                    ...
                    0 == is_ios() && 0 == is_android() && R.css({ transform: "translateY(" + jb + "px)" });
                    requestAnimFrame(jc);
                }
                function kc(e, f, k) {
                    e = { action: "dzsap_submit_like", postdata: e, playerid: f };
                    var l = { refferer: null };
                    k && (l = c.extend(l, k));
                    (a.settings_php_handler || cthis.hasClass("is-preview")) &&
                        c.ajax({
                            type: "POST",
                            url: a.settings_php_handler,
                            data: e,
                ...
                function hb() {
                    0 == Q.height() ? (Q.css({ height: a.design_menu_height }), t.removeClass("menu-closed"), t.addClass("menu-opened")) : (Q.css({ height: 0 }), t.removeClass("menu-opened"), t.addClass("menu-closed"));
                    setTimeout(function () {
                        Sa();
                    }, 400);
                }
                ...
                function lc() {
                    "mode-showall" != a.settings_mode &&
                        0 == x.hasClass("isotoped") &&
                        "one" != a.mode_normal_video_mode &&
                        0 == x.children().eq(z).hasClass("zoomsounds-wrapper-bg-bellow") &&
                ...
                function Lb(e) {
                    ...
                    Ta <= Ba ||
                        ...
                        (Kb = e),
                        0 == is_ios() && 0 == is_android() && "on" != a.enable_easing && R.css({ transform: "translateY(" + Kb + "px)" }));
                }
                function Jb(a) {
                    var e = c(this);
                    if ("click" == a.type && (e.hasClass("menu-item") && ((a = e.parent().children().index(e)), ua(a)), e.hasClass("menu-btn-like") || e.hasClass("menu-facebook-share")))
                        return e.parent().parent().attr("data-playerid") && kc(1, e.parent().parent().attr("data-playerid"), { refferer: e }), !1;
                }
                function Sa() {
                    "mode-showall" != a.settings_mode &&
                        0 == x.hasClass("isotoped") &&
                ...
                function sb() {
                    ...
                    ba--;
                    var c = !0;
                    0 > ba && ((ba = x.children().length - 1), "off" == a.loop_playlist && (c = !1));
                    c && ua(ba);
                }
                function Eb() {
                    ba = z;
                ...
                function ua(e, f) {
                    var k = { ignore_arg_currNr_check: !1, ignore_linking: !1, donotopenlink: "off" };
                    f && (k = c.extend(k, f));
                    if (1 != Ia)
                        if (("last" == e && (e = x.children().length - 1), z == e)) x && x.children().eq(z).get(0) && x.children().eq(z).get(0).api_play_media && x.children().eq(z).get(0).api_play_media({ call_from: "gallery" });
                        else {
                            da = x.children(".audioplayer,.audioplayer-tobe").eq(e);
                            f = "";
                            -1 < z &&
                                ("undefined" != typeof x.children().eq(z).get(0) &&
                                    ("undefined" != typeof x.children().eq(z).get(0).api_pause_media && x.children().eq(z).get(0).api_pause_media(),
                                ...
                                "one" != a.mode_normal_video_mode &&
                                    "mode-showall" != a.settings_mode &&
                                    (x.children().eq(z).removeClass("active active-from-gallery"),
                                    R.children().eq(z).removeClass("active active-from-gallery"),
                                    "fade" == a.transition && (x.children().eq(z).animate({}, { queue: !1 }), setTimeout(Nb, 300), (Ia = !0)),
                            ...
                            1 == Ha && ("off" == a.cueFirstMedia && (a.settings_ap.cue = "off"), (Ha = !1));
                            ...
                            if ("one" == a.mode_normal_video_mode && 0 < e) {
                                ...
                                n &&
                                    n.api_play_media &&
                                    (n.api_change_media(x.children().eq(e), { call_from: "goto_item -- mode_normal_video_mode()" }),
                                    "on" == a.autoplayNext &&
                                        setTimeout(function () {
                                            n.api_play_media();
                                        }, 200));
                            } else Pb(da, l), "on" == a.autoplayNext && ("mode-showall" == a.settings_mode && (z = t.get(0).currNr_2), -1 < z && da.get(0) && da.get(0).api_play && da.get(0).api_play());
                            dzsap_currplayer_focused = da.get(0);
                            "mode-showall" != a.settings_mode &&
                                ("fade" == a.transition && (da.css({}), da.animate({}, { queue: !1 })),
                                da.addClass("transitioning-in"),
                                "link" != da.attr("data-type") &&
                                    0 == k.ignore_linking &&
                                    "on" == a.settings_enable_linking &&
                                    history.pushState({ foo: "bar" }, null, add_query_arg(window.location.href, "audiogallery_startitem_" + ka, e)));
                            ...
                            k &&
                                t.parent().hasClass("ap-wrapper") &&
                                0 < t.parent().children(".the-bg").length &&
                                (t
                                    .parent()
                                    .children(".the-bg")
                                    .eq(0)
                                    .after('<div class="the-bg" style="background-image: url(' + k + ');"></div>'),
                                t.parent().children(".the-bg").eq(0).css({ opacity: 1 }),
                                t.parent().children(".the-bg").eq(1).css({ opacity: 0 }),
                                t
                                    .parent()
                                    .children(".the-bg")
                                    .eq(1)
                ...
                (function () {
                    ...
                    if (0 == k || 1 == k) (a.design_menu_position = "none"), (a.settings_ap.disable_player_navigation = "on");
                    ...
                    if (typeof t.attr("id")) ka = t.attr("id");
                    else {
                        for (k = 0; 0 == c("ag" + k).length; ) k++;
                        ka = "ag" + k;
                        t.attr("id", ka);
                    }
                    ...
                    Q.css({ height: a.design_menu_height });
                    (is_ios() || is_android()) && Q.css({ overflow: "auto" });
                    r();
                    "closed" == a.design_menu_state ? (Q.css({ height: 0 }), t.removeClass("menu-opened"), t.addClass("menu-closed")) : (t.addClass("menu-opened"), t.removeClass("menu-closed"));
                    0 == can_history_api() && (a.settings_enable_linking = "off");
                    0 == t.css("opacity") && t.animate({ opacity: 1 }, 1e3);
                    ...
                    get_query_arg(window.location.href, "audiogallery_startitem_" + ka) &&
                        ((tb = ba = Number(get_query_arg(window.location.href, "audiogallery_startitem_" + ka))),
                        Number(get_query_arg(window.location.href, "audiogallery_startitem_" + ka)) &&
                            0 < Number(get_query_arg(window.location.href, "audiogallery_startitem_" + ka)) &&
                            "on" == a.force_autoplay_when_coming_from_share_link &&
                            (a.autoplay = "on"));
                    ...
                    "mode-showall" == a.settings_mode &&
                        (x.children().each(function () {
                            ...
                            if (e.hasClass("audioplayer-tobe")) {
                                ...
                                f = String(f + 1);
                                2 > f.length && (f = "0" + f);
                                "one-per-row" == a.mode_showall_layout &&
                                    "off" != a.settings_mode_showall_show_number &&
                                    (e.before('<div class="number-wrapper"><span class="the-number">' + f + "</span></div>"), e.after('<div class="clear for-number-wrapper"></div>'));
                            }
                        }),
                        c.fn.isotope &&
                            "one-per-row" != a.mode_showall_layout &&
                            (x.find(".audioplayer,.audioplayer-tobe").addClass("isotope-item"),
                            setTimeout(function () {
                                x.prepend('<div class="grid-sizer"></div>');
                                x.isotope({ itemSelector: ".isotope-item", layoutMode: "fitRows", percentPosition: !0, masonry: { columnWidth: ".grid-sizer" } });
                                x.addClass("isotoped");
                                setTimeout(function () {
                                    x.isotope("layout");
                                }, 900);
                        ...
                        pc &&
                            x.children(".audioplayer").each(function () {
                                var a = c(this);
...
function register_dzsap_aux_script() {
    jQuery(document).ready(function (c) {
        ...
        function v(a) {
            var e = { call_from: "default", lightbox_open: "share", overwrite_this: null };
            a && (e = c.extend(e, a));
            ...
            k
                ? (window.dzsap_currplayer_from_share = k)
                : (console.log("%c could not find this .. maybe we can find it in post_id", "background-color: #da0000;", c('.audioplayer[data-playerid="' + a.attr("data-post_id") + '"]')),
                  a.attr("data-post_id")
                      ? ((window.dzsap_currplayer_from_share = c('.audioplayer[data-playerid="' + a.attr("data-post_id") + '"]').eq(0)), a.data("cthis", window.dzsap_currplayer_from_share))
                      : a.parent().parent().parent().parent().parent().parent().hasClass("audioplayer") && (window.dzsap_currplayer_from_share = a.parent().parent().parent().parent().parent().parent()));
            ...
            if (window.dzsap_box_main_con) {
                ...
                window.dzsap_currplayer_from_share &&
                    ...
                    a && ((k = dzsap_currplayer_from_share.data("embed_code")), -1 == k.indexOf("&lt;") && (k = htmlEntities(k)), (a = a.replace("{{replacewithembedcode}}", k)), f.find(".embed-link-con").html(a)));
                c(document).on("click.dzsap", ".field-for-view", function () {
                    ...
                    if (document.selection) {
                        ...
                        a.select();
                    } else window.getSelection && ((a = document.createRange()), a.selectNode(this), window.getSelection().removeAllRanges(), window.getSelection().addRange(a));
                });
            ...
            } else console.log("warning missing box-main");
        }
        ...
        c(".audioplayer,.audioplayer-tobe").each(function () {
            var a = c(this);
            a.hasClass("auto-init") && 1 == a.hasClass("audioplayer-tobe") && window.dzsap_init && dzsap_init(a, { init_each: !0 });
        });
        ...
        c(document).on("click.dzsap_metas", ".audioplayer-song-changer, .dzsap-wishlist-but", function () {
            ...
            if (a.hasClass("audioplayer-song-changer")) {
                ...
                e && e.get(0) && e.get(0).api_change_media && e.get(0).api_change_media(a, { feeder_type: "button", call_from: "changed audioplayer-song-changer" });
                return !1;
            }
            if (a.hasClass("dzsap-wishlist-but"))
                return (
                    (e = { action: "dzsap_add_to_wishlist", playerid: a.attr("data-post_id"), wishlist_action: "add" }),
                    a.find(".svg-icon").hasClass("fa-star") && (e.wishlist_action = "remove"),
                    window.dzsap_lasto.settings_php_handler &&
                        c.ajax({
                            type: "POST",
        ...
        0 < c(".dzsap-sticktobottom.dzsap-sticktobottom-for-skin-silver").length &&
            setInterval(function () {
                c(".dzsap-sticktobottom.dzsap-sticktobottom-for-skin-silver  .audioplayer").eq(0).hasClass("dzsap-loaded") &&
        ...
        c(document).on("click.dzsap_multisharer", ".dzsap-multisharer-but", function (a, e) {
            ...
            v({ call_from: "click_open_embed_ultibox", lightbox_open: "share", overwrite_this: this });
            return !1;
        });
        c(document).on("keydown.dzsapkeyup keypress.dzsapkeyup", function (a) {
            ...
            if (dzsap_currplayer_focused && dzsap_currplayer_focused.api_pause_media) {
                ...
                if (
                    f &&
                    0 == c(dzsap_currplayer_focused).hasClass("comments-writer-active") &&
                ...
                f = !1;
                -1 < e.step_forward.indexOf("ctrl+") ? a.ctrlKey && ((e.step_forward = e.step_forward.replace("ctrl+", "")), a.keyCode == e.step_forward && (f = !0)) : a.keyCode == e.step_forward && (f = !0);
        ...
        window.dzsap_submit_like = function (a, e) {
            a = { action: "dzsap_submit_like", playerid: a };
            var f = null;
            e && (f = c(e.currentTarget));
            window.dzsap_settings &&
                window.dzsap_settings.ajax_url &&
                c.ajax({
                    type: "POST",
        ...
        window.dzsap_retract_like = function (a, e) {
            a = { action: "dzsap_retract_like", playerid: a };
            var f = null;
            e && (f = c(e.currentTarget));
            window.dzsap_settings &&
                window.dzsap_settings.ajax_url &&
    ...
    jQuery.fn.textWidth = function () {
        ...
        f.css({ "font-size": c.css("font-size"), "font-family": c.css("font-family") });
        c = f.width();
        f.remove();
        return c;
    };
...
function onYouTubeIframeAPIReady() {
    for (i = 0; i < dzsap_yt_list.length; i++) void 0 != dzsap_yt_list[i].get(0) && "undefined" != typeof dzsap_yt_list[i].get(0).fn_yt_ready && dzsap_yt_list[i].get(0).fn_yt_ready();
}
    ...
    c = (function (a) {
        ...
        for (var c = "", e = 0; e < a.length; e++) {
            ...
            128 > f
                ...
                : (127 < f && 2048 > f ? (c += String.fromCharCode((f >> 6) | 192)) : ((c += String.fromCharCode((f >> 12) | 224)), (c += String.fromCharCode(((f >> 6) & 63) | 128))), (c += String.fromCharCode((f & 63) | 128)));
        }
        return c;
    })(c);
    k = (function (a) {
        for (var c = a.length, e = c + 8, f = 16 * ((e - (e % 64)) / 64 + 1), k = Array(f - 1), l, n = 0; n < c; ) (e = (n - (n % 4)) / 4), (l = (n % 4) * 8), (k[e] |= a.charCodeAt(n) << l), n++;
        k[(n - (n % 4)) / 4] |= 128 << ((n % 4) * 8);
        k[f - 2] = c << 3;
        k[f - 1] = c >>> 29;
        return k;
...
window.dzs_open_social_link = function (c, f) {
    ...
    if (f) {
        var W = jQuery;
        W(f).hasClass("audioplayer")
            ? ((a = W(f).parent().children().index(f)), (e = W(f).parent().parent().parent().attr("id")))
            : (jQuery(f).parent().parent().attr("data-menu-index") && (a = jQuery(f).parent().parent().attr("data-menu-index")),
...
function dzsap_send_total_time(c, f) {
    c = { action: "dzsap_send_total_time_for_track", id_track: f.attr("data-playerid"), postdata: parseInt(c, 10) };
...
function get_query_arg(c, f) {
    if (-1 < c.indexOf(f + "=") && ((c = new RegExp("[?&]" + f + "=.+").exec(c)), null != c)) return (c = c[0]), -1 < c.indexOf("&") && (c = c.split("&")[1]), c.split("=")[1];
}
...
window.dzsap_wp_send_contor_60_secs = function (c, f) {
    c = { video_title: f, video_analytics_id: c.attr("data-playerid"), curr_user: window.dzsap_curr_user };
    ...
    jQuery.ajax({ type: "POST", url: f, data: c, success: function (c) {}, error: function (c) {} });
};
function dzsap_call_init_calls() {
    for (var c in window.dzsap_init_calls) window.dzsap_init_calls[c](jQuery);
...
window.dzsap_init = function (c, f) {
    ...
    } else jQuery(c).audioplayer(f);
    dzsap_lasto = f;
    window.dzsap_generate_list_for_sync_players = function (a) {
        var c = { force_regenerate: !1 };
        a && (c = $.extend(c, a));
        window.dzsap_list_for_sync_players = [];
        "undefined" != typeof f &&
            (("undefined" != typeof f.construct_player_list_for_sync && "on" == f.construct_player_list_for_sync) || c.force_regenerate) &&
    ...
    jQuery(document).on("mouseover.dzsap_global", ".dzsap-btn-info", function () {
        var a = jQuery(this);
        a.hasClass("dzsap-btn-info") &&
            (500 > window.innerWidth ? a.offset().left < window.innerWidth / 2 && a.find(".dzstooltip").removeClass("talign-end").addClass("talign-start") : a.find(".dzstooltip").addClass("talign-end").removeClass("talign-start"));
    });
};
window.dzsap_init_multisharer = function () {
    ...
    setTimeout(function () {
        if (!window.dzsap_multisharer_assets_loaded && 1 != window.dzsap_multisharer_assets_loaded && 1 != window.loading_multi_sharer) {
            ...
            f.appendChild(v);
            setTimeout(function () {
                null == window.dzsap_box_main_con &&
                    (c("body").append(
